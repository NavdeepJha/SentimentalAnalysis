...
lbl = Label(window, text="Enter The search Term", font=("Arial", 30))
lbl.grid(column=0, row=0)
txt = Entry(window, width=35)
txt.grid(column=20, row=0)

lbl1 = Label(window, text="Enter Number of terms", font=("Arial", 30))
lbl1.grid(column=0, row=2)
txt1 = Entry(window, width=35)
txt1.grid(column=20, row=2)

lbl1 = Label(window, text="Select Language", font=("Arial", 30))
lbl1.grid(column=0, row=5)

combo = Combobox(window)
combo['values'] = ("English", "Punjabi", "Telgu", "Gujrati", "Bengali")
